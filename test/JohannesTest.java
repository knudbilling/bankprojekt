...
public class JohannesTest {
    ...
    @Test
    public void canMakeATransferFromSavingsToCurrentAccount() {
    ...
    @Test
    public void canMakeATransferFromSavingsToSavingsAccount() {
        Bank bank = new Bank("MinBank", "1234", "12345678901234", "12340000000002", "12340000000009");
        Customer customer = new Customer("firstname", "lastname", "address", "phone");
        bank.addCustomer(customer);
    ...
    public void can_Not_Make_A_Too_Large_Transfer_From_Savings_To_Current_Account() {
        Bank bank = new Bank("MinBank", "1234", "12345678901234", "12340000000002", "12340000000009");
        Customer customer = new Customer("firstname", "lastname", "address", "phone");
        bank.addCustomer(customer);
